                            ...
                            <?php } else { ?>
                                ...
                                <?php if ($signup_type === "new_client" || $signup_type === "verify_email") { ?>
                                    <!-- <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                //         ), "organization", true);
                                                ?>
                                                <label for="type_organization" class="mr15">
                                                    <?php
                                                    // echo app_lang('organization'); 
                                                    ?>
                                                </label>
                                                <?php
                                                // echo form_radio(array(
                                                ...
                                                //         ), "person", false);
                                                ?>
                                                <label for="type_person" class=""><?php
                                                // echo app_lang('individual');
                                                ?></label>
                                            </div>
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="form-group company-name-section">
                                        <label for="company_name" class="col-md-12"><?php echo app_lang('college_name'); ?></label>
                                        <div class="col-md-12">
                                            <select class="form-control" id="college_name" name="college_name">
                                                <option value="">کۆلێژەکەت هەڵبژێرە</option>
                                                <option value="پەروەردە">پەروەردە</option>
