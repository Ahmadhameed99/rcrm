<div class="card bg-white" style="white-space:unset !important;">
    <div class="row justify-content-center" style="padding:6px 15px !important;">
        <div class="col-md-5 col-5">
            <div class="pl30 pt30">
                <div class="b-r">
                    <h3 class="mt-0 mb-1 strong text-danger"><?php echo $reminders_of_today; ?></h3>
                    <div style="white-space:unset !important;" class="text-truncate"><?php echo (($reminders_of_today > 1) ? app_lang("reminders") : app_lang("reminder_today")); ?></div>
                </div>
            </div>
        </div>
            ...
            <div class="pl0 mt5 p30">
                ...
                <div class="text-truncate" >
                    ...
                    if ($next_reminder) {
                        ...
                        echo "<span class='text-off'>" . app_lang("no_reminder") . "</span>";
                    }
                    ?>
                </div>
            </div>
