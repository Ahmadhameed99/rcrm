<div id="page-content" class="page-wrapper clearfix">
    <div class="card clearfix">
        <ul id="password-manager-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs border-top-radius title" role="tablist">
            ...
            <!-- <li><a  role="presentation" href="<?php //echo_uri("password_manager/general_for_client/" . $client_id); ?>" data-bs-target="#general-tab-for-client"> <?php //echo app_lang('general'); ?></a></li> -->
            <!-- <li><a  role="presentation" href="<?php //echo_uri("password_manager/email_for_client/" . $client_id); ?>" data-bs-target="#email-tab-for-client"> <?php //echo app_lang('email'); ?></a></li> -->
            <!-- <li><a  role="presentation" href="<?php //echo_uri("password_manager/credit_card_for_client/" . $client_id); ?>" data-bs-target="#credit-card-tab-for-client"><?php //echo app_lang('password_manager_credit_card'); ?></a></li> -->
            <!-- <li><a  role="presentation" href="<?php //echo_uri("password_manager/bank_account_for_client/" . $client_id); ?>" data-bs-target="#bank-account-tab-for-client"> <?php //echo app_lang('password_manager_bank_account'); ?></a></li> -->
            <li><a  role="presentation" href="<?php echo_uri("password_manager/software_license_for_client/" . $client_id); ?>" data-bs-target="#software-license-tab-for-client"> <?php echo app_lang('password_manager_software_license'); ?></a></li>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".nav-tabs li").click(function () {
            ...
            //task status
            if(activeField === "#software-license-tab-for-client") {
