        ...
        <div class="clearfix">
            <div class="row">
                ...
                <div class="col-md-12 mb5">
                        <div class="font-14 text-justify alert alert-warning"><?php echo app_lang('get_project_password'); ?></div>
                    </div>
                ...
                <div class="col-md-12 mb15">
                    <!-- <span class="text-off font-12">
                        <?php 
                        // echo app_lang("created_by") . " " . $model_info->created_by_user;
                        ?>
                    </span> -->
                    <span class="text-off float-end font-12">
                        <?php echo app_lang("custom_field_created_at") . " " . format_to_datetime($model_info->created_at); ?>
                    </span>
                </div>
                ...
                <?php if ($model_info->url) { ?>
                    <div class="col-md-12 mb15 url-section">
                        <div class="row">
                            <div class="col-md-2">
                                <strong class="float-start mr10 mt-2"><?php echo app_lang('project_file_urls') . ": "; ?></strong>
                            </div>
                            <div class="col-md-10">
                ...
                <?php if ($model_info->version) { ?>
                        <div class="col-md-12 mb15">
                            <div class="row">
                                <div class="col-md-2">
                                    <strong class="float-start mr10 mt-2"><?php echo app_lang('project_asignto') . ": "; ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <pre class="font-14"><?php echo 
                                    $model_info->version; ?> </pre>
                            </div>
                        </div>
                    </div>
                <?php } ?>
                ...
                <div class="col-md-12 mb15 license-key-section">
                    <div class="row">
                        ...
                        <div class="col-md-10" style="border:red;">
                            <pre class="font-14"><a href="#" class="password_show mr5 text-decoration-underline"><?php echo app_lang('password_manager_show'); ?></a> <span style="direction:ltr;text-align:left;" class="password hide"><?php echo $model_info->license_key; ?></span><span data-feather="copy" class="icon-14 float-end clickable text-secondary copy-license-key hide pe-auto mt-1" onclick="copyToClipboard('.password')"></span></pre>
                        </div>
                    </div>
                </div>
...
<div class="modal-footer">
    <?php if ($model_info->created_by == $login_user->id || ($model_info->created_by_client == 1 && $login_user->is_admin)) { ?>
        <?php echo modal_anchor(get_uri("password_manager/software_license_modal_form/"), "<i data-feather='edit' class='icon-16'></i> " . app_lang('edit'), array("class" => "btn btn-success", "title" => app_lang('edit'), "data-post-id" => $model_info->id)); ?>
    <?php } ?>
