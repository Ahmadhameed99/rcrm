...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="url" class=" col-md-3"><?php echo app_lang('project_file_urls'); ?></label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "url",
                        ...
                        "class" => "form-control",
                        "placeholder" => app_lang('project_file_urls')
                    ));
                    ?>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <label for="version" class=" col-md-3"><?php echo app_lang('project_asignto'); ?></label>
                <div class=" col-md-9">
                    <?php
                    // if(empty($model_info->version))
                    // {
                    //     $model_info->version = "<a href='#'>Request#1</a>";
                    // }
                    echo form_input(array(
                        "id" => "version",
                        "name" => "version",
                        ...
                        "class" => "form-control",
                        "placeholder" => app_lang('project_asignto'),
                        "data-rule-required" => true,
                        "data-msg-required" => app_lang("field_required")
                    ));
                    ?>
